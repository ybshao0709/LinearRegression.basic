#'
#'@title Example Data: state.x77
#'
#'@description state.x77 related to the 50 states of the United States of America.
#'
#'@format A dataframe with 50 rows and 8 numerical columns giving the following statistics in the respective columns.
#'
#'\describe{
...
#' \item{Frost:}{mean number of days with minimum temperature below freezing (1931--1960) in capital or large city}
